...
| --- | --- | --- | --- |
| **[Prompting & Context Engineering](prompting-context-engineering/README.md)** | How a model actually consumes what you give it, advanced prompting and its limits, the context window as a finite budget, and persistent memory architecture. | 11 | [prompting-context-engineering/README.md](prompting-context-engineering/README.md) |
| **[Tool Use & the Agentic Loop](tool-use-agentic-loop/README.md)** | Function calling mechanics, the plan-act-observe loop, harness vs scaffolding, computer use, code execution, continuous execution, and knowing when to stop. | 11 | [tool-use-agentic-loop/README.md](tool-use-agentic-loop/README.md) |
...
| **[Model Context Protocol & Agent Interoperability](model-context-protocol/README.md)** | Why MCP exists, its architecture and primitives, building and trusting servers, and the wider interoperability picture. | 7 | [model-context-protocol/README.md](model-context-protocol/README.md) |
...
**All nine subjects are fully authored, now 77/77 lessons after six post-1.1.0 additions.** Eight teach durable
