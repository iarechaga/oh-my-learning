...
| **[Tool Use & the Agentic Loop](tool-use-agentic-loop/README.md)** | Function calling mechanics, the plan-act-observe loop, harness vs scaffolding, computer use, and knowing when to stop. | 9 | [tool-use-agentic-loop/README.md](tool-use-agentic-loop/README.md) |
