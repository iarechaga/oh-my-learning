...
All nine subjects are scaffolded (concept lists and indexes ready). Four are fully
authored - **Prompting & Context Engineering** (10/10), **Tool Use & the Agentic Loop**
(8/8), **Instruction & Context Design** (11/11), and **Model Context Protocol & Agent
Interoperability** (7/7); the remaining five have lesson bodies not yet authored.
