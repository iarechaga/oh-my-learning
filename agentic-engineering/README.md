...
| **[Tool Use & the Agentic Loop](tool-use-agentic-loop/README.md)** | Function calling mechanics, the plan-act-observe loop, harness vs scaffolding, computer use, code execution, and knowing when to stop. | 10 | [tool-use-agentic-loop/README.md](tool-use-agentic-loop/README.md) |
...
**All nine subjects are fully authored, now 75/75 lessons after four post-1.1.0 additions.** Eight teach durable
