...
- **Single agent with retrieval or memory** (`prompting-context-engineering/09`, `prompting-context-engineering/11`) — extends one agent's effective reach without adding another agent at all, appropriate when the problem is really "too much information to hold at once" rather than "genuinely separable lines of work."
