...
**685 lessons, 54 subjects, 9 domains**, from architecture and distributed systems to
...
| **[Agentic Engineering](agentic-engineering/README.md)** | Working effectively with LLMs and building/operating today's agent capabilities: prompting, context and instruction design, tool use, MCP, orchestration, evaluation, and security/cost/operations. | 9 | 76 |

**-> [See all 685 lessons: CATALOG.md](CATALOG.md)** - the full catalog,
