...
**673 lessons, 53 subjects, 9 domains**, from architecture and distributed systems to
...
| **[Agentic Engineering](agentic-engineering/README.md)** | Working effectively with LLMs and building/operating today's agent capabilities: prompting, context and instruction design, tool use, MCP, orchestration, evaluation, and security/cost/operations. | 9 | 71 *(64 authored, rest scaffold)* |

**-> [See all 673 lessons: CATALOG.md](CATALOG.md)** - the full catalog,
