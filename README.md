...
**645 lessons, 49 subjects, 9 domains**, from architecture and distributed systems to
...
| **[Agentic Engineering](agentic-engineering/README.md)** | Working effectively with LLMs and building/operating today's agent capabilities: prompting, context and instruction design, tool use, MCP, orchestration, evaluation, and security/cost/operations. | 9 | 71 *(36 authored, rest scaffold)* |

**-> [See all 645 lessons: CATALOG.md](CATALOG.md)** - the full catalog,
