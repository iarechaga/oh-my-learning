...
**686 lessons, 54 subjects, 9 domains**, from architecture and distributed systems to
...
| **[Agentic Engineering](agentic-engineering/README.md)** | Working effectively with LLMs and building/operating today's agent capabilities: prompting, context and instruction design, tool use, MCP, orchestration, evaluation, and security/cost/operations. | 9 | 77 |

**-> [See all 686 lessons: CATALOG.md](CATALOG.md)** - the full catalog,
